#!/usr/bin/env python3
"""
Qwen3-Next-80B Six-Pass Post-Processing for Transcription Correction
─────────────────────────────────────────────────────────────────────
Six-pass contextual correction using Qwen3-Next-80B (80B parameter model).
...
Pass 5: Speaker diarization final refinement
Pass 6: Transcription error correction final refinement

Features:
• Six-pass processing for maximum accuracy
...
Usage:
    # Normal processing
    python src/post_processing/postprocess_qwen_80b_sixpass.py
...
OUTPUT_ROOT: Final[Path] = PROJECT_ROOT / "results" / "post_processed" / "qwen_80b_sixpass"
...
async def process_file(
    ...
    try:
        ...
        # Pass 5: Diarization final refinement
        pass5 = await pass_diarization(diarization_prompt, pass4, req_sem, pass_num=5)

        # Pass 6: Correction final refinement
        final = await pass_correction(correction_prompt, pass5, req_sem, pass_num=6)
