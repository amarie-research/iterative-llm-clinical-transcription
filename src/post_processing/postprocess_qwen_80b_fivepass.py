#!/usr/bin/env python3
"""
Qwen3-Next-80B Five-Pass Post-Processing for Transcription Correction
──────────────────────────────────────────────────────────────────────
Five-pass contextual correction using Qwen3-Next-80B (80B parameter model).
...
Features:
• Five-pass processing for maximum diarization accuracy
...
Usage:
    # Normal processing
    python src/post_processing/postprocess_qwen_80b_fivepass.py
...
OUTPUT_ROOT: Final[Path] = PROJECT_ROOT / "results" / "post_processed" / "qwen_80b_fivepass"
...
async def process_file(
    ...
    try:
        ...
        final = await pass_diarization(diarization_prompt, pass4, req_sem, pass_num=5)
