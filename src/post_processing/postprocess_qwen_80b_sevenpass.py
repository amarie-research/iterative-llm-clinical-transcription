#!/usr/bin/env python3
"""
Qwen3-Next-80B Seven-Pass Post-Processing for Transcription Correction
───────────────────────────────────────────────────────────────────────
Seven-pass contextual correction using Qwen3-Next-80B (80B parameter model).
...
Pass 7: Speaker diarization final refinement

Features:
• Seven-pass processing for maximum accuracy
...
Usage:
    # Normal processing
    python src/post_processing/postprocess_qwen_80b_sevenpass.py
...
OUTPUT_ROOT: Final[Path] = PROJECT_ROOT / "results" / "post_processed" / "qwen_80b_sevenpass"
...
async def process_file(
    ...
    try:
        ...
        # Pass 7: Diarization final refinement
        final = await pass_diarization(diarization_prompt, pass6, req_sem, pass_num=7)
...
def main():
    with BenchmarkTimer(
        script_name="qwen_80b_sevenpass",
        model_name=MODEL,
        approach="seven-pass",
